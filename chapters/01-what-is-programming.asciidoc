...
[options="header"]
|======
| Programmer  | Processor  | Interface           | Language    | Inputs                        | Result
|  you        | microwave  | microwave buttons   | numbers (?) | 1:00 time, 50% power, start!  | turns on
|======

----
- programmer: you
  processor:  microwave
  interface:  microwave buttons
  language:   numbers   (?)
  inputs:     1:00 time, 50% power, start!
  result: |
...
- programmer: you
  processor:  your friend
  interface:  text
  language:   english

  inputs:     a list of steps in english
  result: |
